...
A parody of the "Activate Windows" watermark on macOS (which now literally displays "Activate Windows" on macOS because I thought that would be funnier). Ported to macOS with ~~Swift~~ Objective-C.
